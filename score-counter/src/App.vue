  ...
  <div id="app" class="container">
    ...
    <div class="card">
      <div class="card-body text-center">
        <h3>Player 1</h3>
        <button @click="descreaseScore(player_1)" type="button" class="btn btn-danger">Down</button>
      ...
      <div class="card-body text-center">
        <h3>Player 2</h3>
        <button @click="descreaseScore(player_2)" type="button" class="btn btn-danger">Down</button>
